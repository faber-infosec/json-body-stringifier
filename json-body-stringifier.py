# Burp Repeater Extension - JSON Body Stringifier
...
class BurpExtender(IBurpExtender, IMessageEditorTabFactory, IContextMenuFactory):
  def registerExtenderCallbacks(self, callbacks):
    ...
    callbacks.setExtensionName('JSON Body Stringifier')
    callbacks.registerMessageEditorTabFactory(self)

  def createNewInstance(self, controller, editable): 
    return JSONBodyStringifierTab(self, controller, editable)

class JSONBodyStringifierTab(IMessageEditorTab):
